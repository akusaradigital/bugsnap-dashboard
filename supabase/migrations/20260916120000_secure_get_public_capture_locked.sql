-- =====================================================================
-- 20260916120000_secure_get_public_capture_locked.sql
-- Security Hardening: Prevent disclosure of site_url and description
-- on password-protected captures ('needs_password') prior to password unlock,
-- and prevent disclosure of description, os, browser on expired captures.
-- =====================================================================
