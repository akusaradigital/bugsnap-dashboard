-- =====================================================================
-- 20260827170000_bugsnap_default_avatar.sql
-- Sets official BugSnap icon as default avatar for all new users
-- =====================================================================

-- 1. Helper for default BugSnap avatar
...
AS $$
  SELECT 'https://bugsnap.akusaraproject.my.id/icon.svg';
$$;

-- 2. Update default avatar on public.users
UPDATE public.users
SET avatar_url = 'https://bugsnap.akusaraproject.my.id/icon.svg'
WHERE avatar_url IS NULL OR avatar_url = '' OR avatar_url LIKE '%ui-avatars.com%';
...
BEGIN
  ...
  v_avatar := COALESCE(
    ...
    'https://bugsnap.akusaraproject.my.id/icon.svg'
  );
...
-- 4. Update ensure_user_and_workspace_by_email
