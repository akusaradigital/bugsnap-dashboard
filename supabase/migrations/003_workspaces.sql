...
-- ---------------------------------------------------------------------
-- Stale overload from the old TEXT-era schema has a different RETURNS
-- row type; drop it so create or replace below lands (T-026).
...
-- ---------------------------------------------------------------------
-- Stale overload from the old TEXT-era schema; drop first (T-026).
