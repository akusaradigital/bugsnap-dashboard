          ...
          <div className="space-y-6">
            ...
            <div className={`${CARD} p-6 space-y-3`}>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-violet-600 text-white flex items-center justify-center shadow-md group-hover:scale-110 group-hover:shadow-indigo-500/25 transition-all duration-300">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-sm font-bold text-slate-900 dark:text-foreground hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
                  >
                    support@akusaradigital.com
                  </a>
                </div>
              </div>
              <p className="text-xs text-muted leading-relaxed pl-13">
                {t("contact.emailDesc")}
              </p>
            </div>
            ...
            <div className={`${CARD} p-6 space-y-3`}>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 text-white flex items-center justify-center shadow-md group-hover:scale-110 group-hover:shadow-purple-500/25 transition-all duration-300">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
            ...
            <div className={`${CARD} p-6 space-y-3`}>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 text-white flex items-center justify-center shadow-md group-hover:scale-110 group-hover:shadow-emerald-500/25 transition-all duration-300">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
            ...
            <div className={`${CARD} p-6 space-y-4`}>
              ...
              <ul className="space-y-3.5 text-xs">
                <li className="flex flex-col gap-0.5">
                  <Link href="/privacy" className="font-semibold text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors">
                    {t("contact.privacy")}
                  </Link>
                ...
                <li className="flex flex-col gap-0.5 border-t border-border/50 pt-3">
                  <Link href="/terms" className="font-semibold text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors">
                    {t("contact.terms")}
                  </Link>
                  <span className="text-muted leading-relaxed">{t("contact.termsDesc")}</span>
                </li>
                <li className="flex flex-col gap-0.5 border-t border-border/50 pt-3">
                  <Link href="/docs" className="font-semibold text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors">
                    {t("contact.docs")}
                  </Link>
