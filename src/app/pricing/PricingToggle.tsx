...
const TIERS = [
  {
    name: "Free",
    tagline: "Everything saved to your own Google Drive - free forever.",
    monthly: 0,
    yearly: 0,
  ...
  {
    name: "Pro",
    tagline: "For teams that deliver and resolve efficiently.",
    monthly: 7,
    yearly: 5,
    ...
    <>
      <div className="flex items-center justify-center gap-3 mb-12">
        ...
        <span className={`text-sm font-medium ${yearly ? "text-foreground" : "text-muted"}`}>
          Yearly <span className="text-emerald-600 font-semibold">(save up to 28%)</span>
        </span>
      </div>
