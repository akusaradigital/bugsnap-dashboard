...
export default function FeaturesPage() {
  return (
    <StaticShell
      ...
      subtitle="BugSnap turns vague bug reports into actionable, context-rich tickets - with screen recordings, network logs, and zero manual setup."
    >
          ...
          <div className="creative-surface rounded-2xl p-6">
            <div className="rounded-xl border border-border bg-subtle/75 p-4 shadow-lg space-y-3 text-center">
              ...
              <p className="text-xs text-muted">
                Files are uploaded directly to <code>Google Drive / BugSnap Captures</code> - your folder, in your account. We never store recordings on our servers, so you can delete or manage them anytime, right from Drive.
              </p>
            </div>
          </div>
        </div>
