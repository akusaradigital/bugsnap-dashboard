    ...
    >
      <div className="space-y-8 font-site text-xs sm:text-sm text-site-text leading-relaxed">
        <section className="space-y-3">
          <h2 className="text-base font-bold text-site-text">1. Acceptance of Terms</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-site-text">2. Description of the Service</h2>
          <p className="text-site-text-2">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-site-text">3. Your Accounts</h2>
          <p className="text-site-text-2">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-site-text">4. Acceptable Use</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-site-text">5. Your Content & Ownership</h2>
          <p className="text-site-text-2">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-site-text">6. Third-Party Services</h2>
          <p className="text-site-text-2">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-site-text">7. Disclaimer of Warranties</h2>
          <p className="text-site-text-2">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-site-text">8. Limitation of Liability</h2>
          <p className="text-site-text-2">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-site-text">9. Termination</h2>
          <p className="text-site-text-2">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-site-text">10. Changes to the Terms</h2>
          <p className="text-site-text-2">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-site-text">11. Governing Law</h2>
          <p className="text-site-text-2">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-site-text">12. Contact</h2>
          <p className="text-site-text-2">
