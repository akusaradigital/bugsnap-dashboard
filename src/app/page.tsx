        ...
        <section className="relative border-t border-white/70 bg-slate-950 overflow-hidden">
          ...
          <div className="relative mx-auto max-w-6xl px-6 py-20 text-center">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <Link
                href="/features"
                className="inline-flex items-center gap-2.5 rounded-2xl bg-white/10 hover:bg-white/20 text-white border border-white/20 px-6 py-3 text-sm font-bold transition-all hover:-translate-y-0.5"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 pb-8 border-b border-slate-200">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-xs text-slate-600">
                ...
                <li><a href="https://chromewebstore.google.com/detail/klbgjodcbhopcjpfehjkbgofjdelohlf" target="_blank" rel="noopener noreferrer" className="hover:text-slate-900 transition-colors">{t("landing.chromeExt")}</a></li>
