        ...
        <section className="mx-auto max-w-6xl px-6 pt-20 pb-16 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-2.5 w-full sm:w-auto justify-center rounded-lg bg-indigo-600 hover:bg-indigo-700 px-6 py-2.5 text-sm font-semibold text-white transition-colors shadow-sm"
            >
            ...
            <a
              href="/pricing"
              className="inline-flex items-center gap-2 w-full sm:w-auto justify-center rounded-lg border border-border bg-white hover:bg-subtle px-6 py-2.5 text-sm font-semibold text-foreground transition-colors"
            >
              {t("landing.pricing")}
            </a>
          </div>
