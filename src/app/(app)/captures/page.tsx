          ...
          <div className="relative w-full max-w-md max-h-[90vh] overflow-y-auto rounded-xl bg-white shadow-xl border border-border p-6">
            ...
            {driveNotConnected && (
              <div className="mt-3 flex items-center gap-3">
                ...
                <button onClick={() => { setDeleteMode("mazway_only"); setDriveNotConnected(false); setDeleteError(null); }} className="text-sm font-medium text-foreground hover:underline">{t("cap.useBugSnapOnly")}</button>
              </div>
            )}
